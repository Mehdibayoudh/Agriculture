...
<!-- Mirrored from ninetheme.com/themes/html-templates/oganik/products.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Sep 2024 12:18:35 GMT -->
...
<div class="page-wrapper">
    ...
    @foreach($blogs as $blog)
        <div class="product-card__image">
            ...
            @else
                <img src="assets/images/default-placeholder.jpg" alt="Default Image"> <!-- Default image if no blog image is available -->
            @endif
        ...
        <div class="col-md-4">
            <div class="product-card__content">
                <div class="product-card__left">
                    <!-- Display blog title -->
                    <h3><a href="{{ route('blogs.show', $blog->id) }}">{{ $blog->titre }}</a></h3>
                    <!-- Display blog content (or a snippet) -->
                    <p>{{ Str::limit($blog->content, 100) }}</p> <!-- Display a snippet of the content -->
                </div><!-- /.product-card__left -->
                <div class="product-card__right">
                    <!-- Static star rating (can be dynamic) -->
